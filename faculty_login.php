...
if(isset($save))
{
	...
	if($e=="" || $p=="")
	{
	$err="<font color='red'>Vui Lòng Nhập Tài Khoảng Mật Khẩu</font>";	
	}
	else
	{
...
$err="<font color='red'>Tài khoản mật khẩu không chính xác!</font>";
...
<form method="post">
	<div class="row">
		...
		<div class="col-sm-4"><h2>Đăng Nhập</h2></div>
	</div>
	...
	<div class="row" style="margin-top:10px">
		<div class="col-sm-4">Nhập Email</div>
		<div class="col-sm-5">
