      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="logout.php"  style="color:#FFFFFF">Đăng Xuất</a></li>
          </ul>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			...
			<li><a href="index.php?page=update_password"><span class="glyphicon glyphicon-user"></span> Đổi Mật Khẩu</a></li>
            <li><a href="index.php?page=update_profile"><span class="glyphicon glyphicon-asterisk"></span> Thay Đổi Thông Tin</a></li>
			 <li><a href="index.php?page=feedback"><span class="glyphicon glyphicon-thumbs-down"></span> Gửi Phản Hồi</a></li>
